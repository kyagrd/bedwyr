...
val toplevel :
  k:(unit -> Parsetree.Preterm.toplevel option) -> Lexing.lexbuf ->
  Parsetree.Preterm.toplevel option option
val term_mode :
  k:(unit -> Parsetree.Preterm.term_mode option) -> Lexing.lexbuf ->
  Parsetree.Preterm.term_mode option option
