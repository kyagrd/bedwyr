...
\verb.pred.'s table: formulas which have been proven or disproven.
In some cases this information can be very relevant. For example, once a 
bisimulation has been checked, the table describes the bisimulation relation.
...
In this list, formulas are marked as proven or disproven. The abstractions at 
the head stand for universal quantifications. Generic variables are not 
abstracted, and represented by \verb.n1., \verb.n2., etc.
