#define "one V W := 
    (sigma X\ sigma M\ V = (in X M), W = (resp (dn X) M))
  ; (sigma X\ sigma Y\ sigma P\ V = (out X Y P), W = (res (up X Y) P))
  ; (sigma P\ V = (taup P), W = (res tau P))
  ; (sigma X\ sigma P\ sigma A\ sigma Q\ V = (match X X P), W = (res A Q), one P (res A Q))
  ; (sigma X\ sigma P\ sigma A\ sigma M\ V = (match X X P), W = (resp A M), one P (resp A M))
  ; (sigma P\ sigma Q\ sigma A\ sigma R\ V = (plus P Q), W = (res A R), one P (res A R))
  ; (sigma P\ sigma Q\ sigma A\ sigma R\ V = (plus P Q), W = (res A R), one Q (res A R))
  ; (sigma P\ sigma Q\ sigma A\ sigma R\ sigma M\ V = (plus P Q), W = (resp A M), one P (resp A M))
  ; (sigma P\ sigma Q\ sigma A\ sigma R\ sigma M\ V = (plus P Q), W = (resp A M), one Q (resp A M))
  ; (sigma P\ sigma Q\ sigma A\ sigma P1\ V = (par P Q), W = (res A (par P1 Q)), one P (res A P1))
  ; (sigma P\ sigma Q\ sigma A\ sigma Q1\ V = (par P Q), W = (res A (par P Q1)), one Q (res A Q1))
  ; (sigma P\ sigma Q\ sigma A\ sigma M\ V = (par P Q), W = (resp A (x\ par (M x) Q)), one P (resp A M))
  ; (sigma P\ sigma Q\ sigma A\ sigma N\ V = (par P Q), W = (resp A (x\ par P (N x))), one Q (resp A N))
  ; (sigma P\ sigma Q\ sigma A\ V = (rx P), W = (res  A (rx Q)), nabla x\ one (P x) (res A (Q x)))
...
%%  ; (sigma P\ sigma Q\ sigma A\ V = (rx P), W = (resp A (y\ (rx x\ (Q x y)))), nabla x\ one (P x) (resp A (y\ Q x y)))
...
%% By rewriting them slightly into the last three clauses above, I was able to get them to parse correctly.
