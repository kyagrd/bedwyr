...
Parsifal, is used for an INGA team associated with the ``Slimmer''
...
In definitions, uppercase variables are implicitly universally quantified.
...
particular, the backspace is used to denote the $\lambda$-binder.  The
