...
\label{logic}
% - the logic behind Bedwyr (bindings, definitions, finite success/failure, nabla)
...
% % - logic programming (query, trace, operational semantics)
